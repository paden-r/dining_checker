...
// pub static SPACE_URL: Lazy<String> = Lazy::new(|| format!("{}/finder/api/v1/explorer-service/dining-availability/%7B9DDDAEF3-9DAC-46B6-B55B-A12FC04588DF%7D/wdw/16660079;entityType=restaurant/table-service/2/2023-09-13/?mealPeriod=80000717", DISNEY_ROOT_URL));
